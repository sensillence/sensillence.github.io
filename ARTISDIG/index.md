...
* Mäyrä, V. and Laaksonen J. (2024). Foresty Variable Prediction with Multiresolution Hyperspectral, RGB and Panchromatic Inputs. To be submitted to the IEEE International Geoscience and Remote Sensing Symposium (IGARSS).
